 ...
 */
final class Version20210723170637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE todolist (id INT AUTO_INCREMENT NOT NULL, author_id INT UNSIGNED NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_DD4DF6DBF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE todolist ADD CONSTRAINT FK_DD4DF6DBF675F31B FOREIGN KEY (author_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE todolist_tags ADD CONSTRAINT FK_236546CFB3AB48EB FOREIGN KEY (to_do_list_id) REFERENCES todolist (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE todolist DROP FOREIGN KEY FK_DD4DF6DBF675F31B');
